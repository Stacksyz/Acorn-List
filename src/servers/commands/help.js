...
module.exports.run = async (client,message,args) => {
    ...
    .setFooter(" Page 1/8 Powered by SnowBots.cf")

let embed1 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle(":musical_note: SnowBots Music")
    ...
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 2/8 Powered by SnowBots.cf")

    let embed2 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:bot:876940784119734312> SnowBots Botlist")
    ...
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:ServerTag:879478250961776660> SnowBots Serverlist")
    .setDescription("> `boost,` `bump,` `vote,` `link,` `profile`")
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 3/8 Powered by SnowBots.cf")

    let embed4 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:util:879478933672841226> SnowBots Utility")
    .setDescription("> `whois,` `serverinfo`")
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 4/8 Powered by SnowBots.cf")

    let embed5 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:admin:879478601609781329> SnowBots Admin")
    .setDescription("> `queue,` `steal`")
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 5/8 Powered by SnowBots.cf")

    let embed6 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:uptime:876259414678593596> SnowBots Extras")
    .setDescription("> `faq,` `emojis,` `support,` `addbot,` `addserver,` `topvoted,` `ping,` `poke`")
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 6/8 Powered by SnowBots.cf")

    let embed7 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:premium:879478503697952818> SnowBots Premium")
    .setDescription("> `shorturl`")
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 7/8 Powered by SnowBots.cf")

    let embed8 = new MessageEmbed()
    .setAuthor(message.author.tag, message.author.avatarURL({dynamic: true}))
    .setColor("#0x2f3136")
    .setTitle("<:newspaper:872523515230847027> SnowBots News")
    .setDescription("**Latest News!**\n\nTitle: **Added Few New Commands**\n> I have finally added a few new comamnds, `steal,` and `poke` as well ad MUSIC COMMANDS! Enjoy!\n\nOops...\nLooks like thats the end of our News!\n\nView More News [here](https://SnowBots.cf/news)")
    .setImage('https://cdn.discordapp.com/attachments/878005921895309383/880945510335250472/welcomeimg_6.png')
    .setFooter(" Page 8/8 Powered by SnowBots.cf")
   ...
   const embedPages = new MessageButtonPages()
    ...
    .setMessage("Powered by SnowBots.cf!", true) // {boolean} True = react emoji when the message success send
